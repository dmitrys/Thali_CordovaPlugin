...
// It tests only race condition described in #1510, but not solution.
test.only('notification client correctly handles peer availability changes ' +
    ...
    switch (callsCount) {
      case 1:
        ...
        action.start(keepAliveAgent).then( function () {
          ...
          // resolution and notificationCliend scheduled retry for the failed
